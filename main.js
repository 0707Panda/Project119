...
function gotResults(error, results){
    if(error){
        ...
        document.getElementById("sketchlabel").innerHTML="your sketch:"+drawn_sketch;
        document.getElementById("confidencelabel").innerHTML="confidence"+Math.round(results[0].confidence*100)+"%";
    }
}
